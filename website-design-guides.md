# AI UI Prompt Framework — 5 Dimensions + Anti-Patterns
...
Don't just say: *"Create a landing page"* — instead, specify the functional pattern based on your product type.
...
- Focus: Clear data visualisation, security badges, transparent pricing
...
- Technical: `box-shadow: inset + outset`, same-colour palette, minimal contrast
...
**Bento Grid**
- Keywords: Modular, clean, organised, information-dense, modern, structured
...
| Y2K Revival | Metallic, chrome effects, bold colours, retro-futuristic |
| Claymorphism | 3D inflated, soft shadows, playful, tactile |
| Gradient Mesh | Complex multi-colour gradients, organic flow |
| Minimalist Luxury | Maximum white space, serif typography, subtle gold accents |
| Cyberpunk | Neon colours, glitch effects, tech-noir, high energy |
...
- Create semantic colour tokens (`--color-success`, `--color-error`)
- Test in both light and dark modes

❌ DON'T:
- Use more than 3 primary colours
- Use pure black (`#000`) on pure white (`#FFF`) — too harsh
- Rely on colour alone for information (accessibility)
...
- Glow:        Outer glow on hover (box-shadow with colour)
...
```css
/* Focus Glow */
- Ring:        2–4px outline with brand colour at 50% opacity
- Glow:        Soft box-shadow with brand colour
- Border shift: Border colour change + subtle scale
...
/* Exit */
- Reverse animation, faster duration (200ms)
```
...
- Colour:         Light grey (#E5E7EB) on white
...
- No more than 3 primary colours
...
### ❌ Performance Sins
- No unoptimised images (use WebP, lazy loading)
