...
> A comprehensive framework for prompting AI agents to create beautiful, functional, and high-performing user interfaces. Based on the UI/UX Pro Max methodology.

**Reference:** [AI Studio](https://aistudio.google.com/apps) — copy and paste desired sections directly into prompts.
...
> [!tip] Don't just say "Create a landing page"
> Specify the functional pattern based on your product type.
...
*The Soul — this is what transforms "good" into "Pro Max"*
...
/* Exit */
- Reverse animation, faster (200ms)
```
...
- Shape:    Match final content layout
...
**Always include this accessibility override:**
```css
...
> [!warning] Tell your AI agent explicitly what NOT to do
...
*Tags: #design #ui-ux #framework #prompting #frontend*